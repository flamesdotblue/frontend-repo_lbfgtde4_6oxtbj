      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24">
        <div className="max-w-3xl">
          <h1 className="text-4xl sm:text-6xl font-semibold tracking-tight text-white">
            Minimal. Retro. Futuristic.
          </h1>
          <p className="mt-4 text-white/70 text-lg">
            Precision timepieces blending eras — engineered for clarity, presence, and lasting character.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
            <a href="/collections" className="rounded-full bg-white text-black px-6 py-3 font-medium hover:opacity-90 transition">
              Explore Collections
            </a>
            <a href="/about" className="rounded-full border border-white/20 text-white px-6 py-3 font-medium hover:bg-white/10 transition">
              Our Ethos
            </a>
          </div>
        </div>
